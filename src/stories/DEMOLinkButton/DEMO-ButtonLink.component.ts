...
import { PopUpDialogueButtonComponent } from '../Button That Create PopUp Dialogue/PopUpDialogueButton.component';
import { BodyBoxComponent } from '../../app/body-box/body-box.component';
import { ButtonsWithLinksComponent } from '../ButtonswithLinks/ButtonsWithLinks.component';
@Component({
  selector: 'BaseModal-Links',
  standalone: true,
  imports: [CommonModule, PopUpDialogueButtonComponent,
            BodyBoxComponent, ButtonsWithLinksComponent],
  template: `
