...
import { PopUpFormButtonComponent } from '../Button That Creates PopUp Form/PopUpFormButton.component';
...
@Component({
  selector: 'Demo-BaseModal',
  standalone: true,
  imports: [CommonModule, PopUpFormButtonComponent,
            BodyBoxComponent, BaseModalComponent],
  template: `
